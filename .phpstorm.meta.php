...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\wamp\www\vomuoi-store1\public\storage' => 'string',
            ...
            'services.google.guzzle.verify' => 'string',
...
'filesystems.links.D:\\wamp\\www\\vomuoi-store1\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'services.google.guzzle.verify','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'web','api',);
        registerArgumentsSet('routes', 'homepage','products.index','product.show','product.category',
'about','contact','promo','cart.index','cart.add',
'cart.update','cart.remove','cart.clear','cart.info','user.profile',
'user.profile.update','user.change-password','user.orders','user.orders.detail','checkout.show',
'checkout.store','checkout.success','momo.payment','momo.callback','momo.ipn',
'momo.status','login','login.post','register','register.post',
'auth.google','logout','admin.dashboard','admin.products',
'admin.products.create','admin.products.store','admin.products.edit','admin.products.update','admin.products.delete',
'admin.products.toggle-status','admin.categories','admin.categories.create','admin.categories.store','admin.categories.edit',
'admin.categories.update','admin.categories.delete','admin.categories.toggle-status','admin.orders','admin.orders.show',
'admin.orders.update-status','storage.local',);
        registerArgumentsSet('views', 
'admin.categories.create','admin.categories.edit','admin.categories.index','admin.dashboard','admin.layouts.app',
'admin.orders.index','admin.orders.show','admin.products.create','admin.products.edit','admin.products.index',
'auth.login','auth.register','cart.checkout','cart.checkout-success','cart.index',
'categories.create','categories.edit','categories.index','components.cart-modal','emails.admin-order-notification',
'emails.order-confirmation','layouts.app','layouts.banner','layouts.footer','layouts.header',
'pages.about','pages.contact','pages.homepage','pages.promo','products.category',
'products.index','products.show','user.orders','user.profile','welcome',
...
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','D:.wamp.www.vomuoi-store1.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAIL_ADMIN','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','MOMO_ENDPOINT',
'MOMO_ENDPOINT_QUERY','MOMO_PARTNER_CODE','MOMO_ACCESS_KEY','MOMO_SECRET_KEY','MOMO_RETURN_URL',
'MOMO_NOTIFY_URL','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI',);
