...
@section('title', 'Đăng ký - VoMuoi Store')

@section('content')
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-pink-50 py-12 px-4">
    <div class="max-w-md w-full">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Đăng ký tài khoản</h1>
            <p class="text-gray-600">Tạo tài khoản để trải nghiệm đầy đủ</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form action="{{ route('register.post') }}" method="POST">
                ...
                <!-- Submit Button -->
                <button type="submit"
                        class="w-full px-6 py-3 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition shadow-lg">
                    Đăng ký
                </button>
            </form>
            ...
            <a href="{{ route('auth.google') }}"
               class="w-full flex items-center justify-center gap-3 px-6 py-3 border-2 border-gray-300 rounded-lg hover:bg-gray-50 transition font-semibold text-gray-700">
        ...
        <div class="mt-6 text-center">
            <a href="{{ route('homepage') }}" class="text-gray-600 hover:text-purple-600 transition">
                ← Quay về trang chủ
            </a>
        </div>
    </div>
