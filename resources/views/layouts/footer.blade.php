...
<footer class="bg-gray-900 text-gray-300 mt-20">
    <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <!-- Company Info -->
            <div>
                <h3 class="text-white text-xl font-bold mb-4">Home_VoMuoi</h3>
                <p class="text-sm text-gray-400 mb-4">
                    Chuyên cung cấp nội thất cao cấp cho không gian sống hiện đại
                </p>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('homepage') }}" class="text-sm hover:text-white transition">Trang chủ</a></li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-sm hover:text-white transition">Chính sách đổi trả</a></li>
                    <li><a href="#" class="text-sm hover:text-white transition">Chính sách bảo hành</a></li>
                    <li><a href="#" class="text-sm hover:text-white transition">Hướng dẫn mua hàng</a></li>
                    <li><a href="#" class="text-sm hover:text-white transition">Phương thức thanh toán</a></li>
                    <li><a href="#" class="text-sm hover:text-white transition">Câu hỏi thường gặp</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="flex items-start text-sm">
                        ...
                        <span>Hoài Đức, Hoài Nhơn, Bình Định</span>
                    </li>
    ...
    <div class="border-t border-gray-800">
        <div class="max-w-7xl mx-auto px-4 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
                <p>&copy; {{ date('Y') }} isofa. All rights reserved.</p>
